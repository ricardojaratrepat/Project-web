...
class SolutionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create solution" do
    assert_difference("Solution.count") do
      post solutions_url, params: { solution: { date: @solution.date, evaluation: @solution.evaluation, feedback: @solution.feedback, selected: @solution.selected, ticket_id: @solution.ticket_id } }
    end
  ...
  test "should update solution" do
    patch solution_url(@solution), params: { solution: { date: @solution.date, evaluation: @solution.evaluation, feedback: @solution.feedback, selected: @solution.selected, ticket_id: @solution.ticket_id } }
